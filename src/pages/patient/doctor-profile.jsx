  ...
  return (
    <div className="w-full sm:flex h-full">
      ...
      <div className="sm:w-4/5 bg-[#F6F6F6] h-full">
        ...
        <div className="h-full w-full p-8 flex items-start gap-8">
          <section className="sm:w-3/4">
            <div className="bg-white flex items-center justify-start gap-6 p-8 rounded-lg">
              <div className="">
                <img
                  src={doctor.image}
                  alt={doctor.name}
            ...
            <div className="mt-8 bg-white p-8 mb-8 rounded-lg">
              <h2 className="text-[34px] font-bold pb-2">Biography</h2>
              <p className="text-[18px] pb-4">{doctor.biography}</p>

              <h2 className="text-[24px] font-bold pb-2">Department</h2>
              <p className="text-[18px] pb-4">{doctor.department}</p>

              <h2 className="text-[24px] font-bold pb-2">Specialization</h2>
              <p className="text-[18px] pb-4">{doctor.specialization}</p>

              <h2 className="text-[24px] font-bold pb-2">Qualifications</h2>
              <p className="text-[18px] pb-4">{doctor.qualifications}</p>

              <h2 className="text-[24px] font-bold pb-2">
                Years of Experience
              </h2>
              <p className="text-[18px] pb-4">{doctor.yearsOfExperience}</p>
            </div>
          </section>
